...
3. Run **Test connection**. Callable calls Zendesk's real `GET /api/v2/users/me.json` endpoint and records the actual remote error if credentials or connectivity are invalid.
